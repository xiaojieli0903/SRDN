...
-- Optimization
cmd:option('-num_epoch', 100)--100 is woo much.change to 30/20
cmd:option('-batch_size',10 )--origin is 16,too much for the computer.change it to 10
cmd:option('-learning_rate', 1e-3)--train3.lua  decrease it when train
       ...
       table.insert(train_loss_history,loss_epoch)
        ...
        if epoch % opt.checkpoint_every == 0 then
			...
			for j = 1, val_batches do
				...
				table.insert(val_loss_history,loss)
